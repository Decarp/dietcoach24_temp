...
const PdfDocument: React.FC<PdfDocumentProps> = ({ session, enrichedRecommendations, patient }) => {
    const renderHeader = () => (
            ...
            <Page size="A4" style={styles.page}>
                ...
                <View style={styles.section}>
                    {enrichedRecommendations.map((rec, index) => {
                        ...
                        const alternativeProductsEmpty = rec.suggestions.alternatives.length === 0;
                                    ...
                                    <View style={styles.table}>
                                        ...
                                        <View style={styles.tableRow}>
                                            <View style={styles.tableColHeader}>
                                                <Text style={styles.tableCellHeader}>Gekaufte Produkte</Text>
                                            </View>
                                            <View style={styles.tableColHeader}>
                                                <Text style={styles.tableCellHeader}>Alternative Produkte</Text>
                                            </View>
                                        </View>
                                        ...
                                        <View style={styles.tableRow}>
                                            ...
                                            <View style={styles.tableCol}>
                                                {!alternativeProductsEmpty &&
                                                    rec.suggestions.alternatives.map((alternativeProduct, idx) => (
                                                        <View key={idx}>
                                                            <Text style={styles.tableCell}>
                                                                <Text style={styles.subheading}>
