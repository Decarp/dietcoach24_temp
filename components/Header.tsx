...
import { ArrowLeftStartOnRectangleIcon, ArrowRightEndOnRectangleIcon, UserCircleIcon } from '@heroicons/react/24/solid';
                        ...
                        <div className="flex h-16 justify-between">
                            <div className="flex">
                                <Link className="flex flex-shrink-0 items-center" href="/">
                                    <p className="text-primary font-base text-2xl font-sans">DietCoach</p>
