...
const AnalysisHeader = () => {
    const { currentTab, setCurrentTab, hideBaskets, setHideBaskets, hideProducts, setHideProducts } = useCounterStore(
        (state) => state,
    );
            ...
            <div className="w-full">
                <div className="relative flex justify-between mb-5">
                    ...
                    <div className="flex-grow text-center">
                        ...
                        <h3 className="text-xs font-light text-gray-500">Filtere Lebensmittel</h3>
                    </div>
