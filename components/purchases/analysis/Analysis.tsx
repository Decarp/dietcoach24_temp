...
const Analysis = () => {
    ...
    useEffect(() => {
        if (basketProducts.length > 0 && JSON.stringify(basketProducts) !== JSON.stringify(currentBasketProducts)) {
      ...
      `}
        >
            ...
            <div className="shadow-inner -mx-6">
                <div className="flex-1 h-[calc(100vh-320px)] overflow-y-auto pb-6 px-6">
                            ...
                            {currentTab === 'energy' && (
                                <>
                                    ...
                                    <ChartEnergyCategories
                                        ...
                                        replace={true}
                                        className={`${hideProducts || hideBaskets ? 'bg-gray-50' : 'bg-white'}`}
                                    />
                            ...
                            <div className="flex mt-12 px-4">
                                ...
                                <div className="text-center">
                                    ...
                                    <p className="mt-2 text-sm text-gray-500">
                                        Wählen Sie mindestens einen Einkauf aus, um Analysen anzuzeigen.
                                    </p>
                                </div>
                            </div>
                        )
