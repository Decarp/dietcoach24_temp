...
export default function SelectedAlternativesSection() {
    ...
    const { selectedAlternativeProducts, setSelectedAlternativeProducts } = useCounterStore((state) => state);
    ...
    return (
        <div className="bg-white border border-gray-300 rounded-md">
            ...
            <div className="mt-1 flex items-center py-2 px-4 border border-gray-300 border-0 border-b">
                <h3 className="w-full block text-sm font-medium text-gray-500">Alternative Produkte</h3>
            ...
            <div className="flex justify-center p-4">
                <Button onClick={() => handlePopopOpen(true)} icon={<PlusIcon className="h-5 w-5" />}>
