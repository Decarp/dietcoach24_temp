...
export default function CompletedPopup({ open, setOpen }: { open: boolean; setOpen: (open: boolean) => void }) {
                            ...
                            <div className="mt-3 text-center sm:mt-5">
                                ...
                                <div className="mt-2">
                                    <p className="text-sm text-gray-500">
                                        Vielen Dank für die Erstellung der Empfehlung. Sie können nun entweder eine
                                        weitere Empfehlung erstellen oder den Fragebogen ausfüllen.
                                    </p>
                                </div>
                            </div>
                        </div>
