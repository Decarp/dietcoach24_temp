        ...
        <Popover className="z-50 relative inline-block text-left">
            <div>
                <PopoverButton className="group inline-flex items-center justify-center text-sm font-medium text-gray-700 hover:text-gray-900">
                    <span className="flex-none">Filter ({selectedCategories.major.length})</span>
                    <ChevronDownIcon
                        aria-hidden="true"
                            ...
                            <div key={category.major}>
                                <div className="flex items-center">
                                    <input
                                        ...
                                        onChange={() => updateCategories(category.major, 'major', true)}
                                        ...
                                        .map((subCategory) => (
                                            <div key={subCategory} className="flex items-center">
                                                <input
                                                    ...
                                                    onChange={() => updateCategories(subCategory, 'sub', true)}
                                                    className="h-4 w-4 rounded border-gray-300 text-primary focus:ring-primary cursor-pointer"
                                                />
