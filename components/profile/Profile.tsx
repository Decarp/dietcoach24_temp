                    ...
                    <div className="py-2">
                        <dl className="grid grid-cols-1 sm:grid-cols-2">
                            <div className="px-4 py-4 sm:col-span-1 sm:px-0">
                                <dt className="text-sm font-normal leading-6 text-gray-500">Alter</dt>
                                <dd className="mt-1 text-sm leading-6 text-gray-700 sm:mt-2">
                                    {patient?.demographics.age}
                                </dd>
                            </div>
                            <div className="px-4 py-4 sm:col-span-1 sm:px-0">
                                <dt className="text-sm font-normal leading-6 text-gray-500">Geschlecht</dt>
                                <dd className="mt-1 text-sm leading-6 text-gray-700 sm:mt-2">
                            ...
                            <div className="px-4 py-4 sm:col-span-1 sm:px-0">
                                <dt className="text-sm font-normal leading-6 text-gray-500">Diagnose</dt>
                                <dd className="mt-1 text-sm leading-6 text-gray-700 sm:mt-2">
                        ...
                        <dl className="mt-5 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3">
                            <div className="relative overflow-hidden rounded-lg bg-white p-6 rounded-md border border-gray-300">
                                <dt>
                                    ...
                                    <p className="ml-16 truncate text-sm font-medium text-gray-500">Haushaltsgröße</p>
                                </dt>
                                <dd className="ml-16 flex items-baseline">
                                    <p className="text-2xl font-semibold text-gray-900">{patient?.householdSize} </p>
                            ...
                            <div className="relative overflow-hidden rounded-lg bg-white p-6 rounded-md border border-gray-300">
                                <dt>
                                    ...
                                    <p className="ml-16 truncate text-sm font-medium text-gray-500">Einkaufsfrequenz</p>
                                </dt>
