...
export default function AddPatientDrawer({ open, setOpen }: { open: boolean; setOpen: (open: boolean) => void }) {
    ...
    const mutation = useMutation({
        mutationFn: (newPatientId: string) => createPatient(newPatientId, sessionData?.accessToken || ''),
        onSuccess: () => {
