    ...
    const handleRegister = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                const createPatientResponse = await createPatient(patientId, responseData.token);
                ...
                const createSessionResponse = await createSession(patientId, responseData.token);
        ...
        <main className="px-4 py-8 sm:px-6 lg:px-8">
            <div className="bg-white h-screen -m-8 p-8 border-x border-b border-gray-300 h-[calc(100vh-68px)]">
                ...
                <form onSubmit={handleRegister} className="space-y-4">
                    ...
                    <Button onClick={() => {}} icon={<UserPlusIcon className="h-5 w-5" />}>
                        Registrieren
                    </Button>
                </form>
            </div>
