...
export const getChartEnergyMacroCategoriesData = (
    ...
    const dynamicChartEnergyMacroCategoriesResponse = aggregateMacroCategories(productsFlattened, selectedMacro);

    return mapChartEnergyMacroCategoriesResponse(dynamicChartEnergyMacroCategoriesResponse);
};
